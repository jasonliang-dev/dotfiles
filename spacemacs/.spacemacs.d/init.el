...
you should place your code here."
  ...
  (set-face-background 'mode-line "#313440")
  (set-face-background 'powerline-active1 "#1D2026")
  (set-face-background 'powerline-active2 "#1D2026")
