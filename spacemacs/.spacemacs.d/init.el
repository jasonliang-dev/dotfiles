...
values."
  (setq-default
   ...
   '(
     ...
     html
     java
     (javascript :variables js2-strict-trailing-comma-warning nil)
     latex
     markdown
     org
...
you should place your code here."
  ...
  (setq eclim-eclipse-dirs '("~/eclipse/java-oxygen/eclipse")
        ...
        eclimd-executable "~/.p2/pool/plugins/org.eclim_2.7.1/bin/eclimd")
  ...
  (set-face-background 'powerline-active1 "#21242b")
  (set-face-background 'powerline-active2 "#21242b")

  ;; change how the modeline appears
