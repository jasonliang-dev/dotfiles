...
#+BEGIN_SRC emacs-lisp
  (use-package general
    :ensure t
    :config
    (setq viper-mode nil) ;; don't viperize Emacs. There's evil mode for that
    (require 'viper) ;; viper-(forward|backward)-word
    ...
    (general-define-key
     ...
     [remap forward-word] 'viper-forward-word ;; vim word movement behaviour
     [remap backward-word] 'viper-backward-word
