...
terminal = os.getenv("HOME") .. "/scripts/term.sh"
...
local mytextcalendar = wibox.widget.textclock(lain.util.markup.fg.color(beautiful.base05, "  %B %d"))
local mytextclock = wibox.widget.textclock(lain.util.markup.fg.color(beautiful.base05, "  %I:%M%P"), 10)
    ...
    function(s)
        ...
        local function info_group(widgets, bg_color)
            ...
            return wibox.container.background(
                wibox.container.margin(wibox.widget(widgets), outer_padding, outer_padding),
                bg_color
            )
        end
