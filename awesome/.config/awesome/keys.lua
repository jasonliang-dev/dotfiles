...
keys.globalkeys =
    ...
    awful.key(
        ...
        "Return",
        function()
            awful.spawn.with_shell(os.getenv("HOME") .. "/scripts/files.sh")
        end,
    ...
    awful.key(
        ...
        "d",
        function()
            awful.spawn.with_shell("/home/jason/scripts/rofi.sh")
        end,
    ...
    awful.key(
        ...
        function()
            awful.spawn.with_shell(os.getenv("HOME") .. "/scripts/brightness.sh down")
        end,
    ...
    awful.key(
        ...
        "XF86MonBrightnessUp",
        function()
            awful.spawn.with_shell(os.getenv("HOME") .. "/scripts/brightness.sh up")
        end,
    ...
    awful.key(
        ...
        "XF86AudioPlay",
        function()
            awful.spawn.with_shell(os.getenv("HOME") .. "/scripts/audio.sh play")
        end,
    ...
    awful.key(
        ...
        "XF86AudioStop",
        function()
            awful.spawn.with_shell(os.getenv("HOME") .. "/scripts/audio.sh stop")
        end,
    ...
    awful.key(
        ...
        "XF86AudioPrev",
        function()
            awful.spawn.with_shell(os.getenv("HOME") .. "/scripts/audio.sh prev")
        end,
    ...
    awful.key(
        ...
        "XF86AudioNext",
        function()
            awful.spawn.with_shell(os.getenv("HOME") .. "/scripts/audio.sh next")
        end,
